...
It complies with the [micro.Client](https://godoc.org/github.com/smart-echo/micro/client#Client) interface.
...
```go
import "github.com/smart-echo/micro-plugins/client/http"
...
```go
import _ "github.com/smart-echo/micro-plugins/client/http"
```
