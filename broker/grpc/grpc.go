...
import (
	...
	proto "github.com/smart-echo/micro-plugins/broker/grpc/proto"
...
var (
	registryKey = "github.com/smart-echo/micro/registry"
...
func newGRPCBroker(opts ...broker.Option) broker.Broker {
	...
	proto.RegisterBrokerServer(h.srv, &grpcHandler{g: h})
...
func (h *grpcHandler) Publish(ctx context.Context, msg *proto.Message) (*proto.Empty, error) {
	if len(msg.Topic) == 0 {
		return nil, merr.InternalServerError("micro.broker", "Topic not found")
	}
